<?php
	...
	$sql = "SELECT *, SUM(numero_horas) AS total_hr, a.empleado_id AS empid, e.empleado_id AS employee FROM asistencia as a LEFT JOIN empleado as e ON e.id=a.empleado_id LEFT JOIN posicion as p ON p.id=e.posicion_id WHERE date BETWEEN '$from' AND '$to' GROUP BY a.empleado_id ORDER BY e.apellido ASC, e.nombre ASC";
			...
			<table cellspacing="0" cellpadding="3">  
    	       	<tr>  
            		<td width="25%" align="right">Nombre Empleado: </td>
                 	...
                 	<td width="25%" align="right">'.number_format($row['tasa'], 2).'</td>
    	    	</tr>
    	    	<tr>
    	    	...
    	    	<tr> 
    	    		...
    	    		<td></td>
				 	...
				 	<td width="25%" align="right"><b>'.number_format(($row['tasa']*$row['total_hr']), 2).'</b></td> 
    	    	</tr>
    	    	<tr> 
    	    		<td></td> 
    	    		<td></td>
