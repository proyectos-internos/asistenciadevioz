                      ...
                      <select class="form-control" id="schedule" name="schedule" required>
                        ...
                        <?php
                          ...
                          while($srow = $query->fetch_assoc()){
                            echo "
                              <option value='".$srow['id']."'>".$srow['tiempo_entrada'].' - '.$srow['tiempo_salida']."</option>
                            ";
                          }
                        ?>
                      </select>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9"> 
                      <select class="form-control" name="gender" id="edit_gender">
                        <option hidden id="gender_val"></option>
                ...
                <script>
                  const genderValue = document.getElementById("#gender_val")
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" name="position" id="edit_position">
                        ...
                        <?php
                          ...
                          while($prow = $query->fetch_assoc()){
                            echo "
                              <option value='".$prow['descripcion']."'>".$prow['descripcion']."</option>
                            ";
                          }
                        ?>
                      </select>
                ...
                <script>
                  const genderValue = document.getElementById("#position_val")
                  const selectGender = document.getElementById("#edit_position")
                  selectGender.value = genderValue
                </script>
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" id="edit_schedule" name="schedule">
                        ...
                        <?php
                          ...
                          while($srow = $query->fetch_assoc()){
                            echo "
                              <option value='".$srow['tiempo_entrada']."'>".$srow['tiempo_entrada'].' - '.$srow['tiempo_salida']."</option>
                            ";
                          }
                        ?>
                      </select>
