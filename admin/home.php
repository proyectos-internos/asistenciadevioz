      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
            <?php
              $sql = "SELECT COUNT(*) as total, SUM(estado = 1) as early FROM asistencia";
              $query = $conn->query($sql);
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <?php
                $sql = "SELECT * FROM asistencia WHERE fecha = '$today' AND estado = 1";
                $query = $conn->query($sql);
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <?php
                $sql = "SELECT * FROM asistencia WHERE fecha = '$today' AND estado = 0";
                $query = $conn->query($sql);
...
<?php
  ...
  $late = array();
  for( $m = 1; $m <= 12; $m++ ) {
    $sql = "SELECT * FROM asistencia WHERE MONTH(fecha) = '$m' AND estado = 1 $and";
    $oquery = $conn->query($sql);
    array_push($ontime, $oquery->num_rows);

    $sql = "SELECT * FROM asistencia WHERE MONTH(fecha) = '$m' AND estado = 0 $and";
